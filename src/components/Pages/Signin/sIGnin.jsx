    ...
    return (
        <div className="maindiv">
            <div className="subdic">
                ...
                <div className="k1"> <span> Sign in</span>
                </div>
                <div className="k2">
                    <span>Use your Google Account</span>
                </div>
                <div className="k3">
                    {/* <input className="k4" type="textfield" value={"Email or phone"}/> */}
                    <TextField className="k4" onChange={takeEmail} error={regexObj.emailBorder} helperText={regexObj.emailHelper} label="Email or phone" variant="outlined" />
                    <span className="k5">
                        <Button className="w1" variant="text">Forgot email?</Button>
                    </span>
                </div>
                <div className="k6">
                    {/* <input className="k7" type="textfield" value={"Password"}/> */}
                    <TextField className="k7" onChange={takePassword} error={regexObj.passwordBorder} helperText={regexObj.passwordHelper} label="Password" variant="outlined" />
                    <span className="k8">
                        <Button variant="text"> Forgot password?</Button>
                    </span>
                </div>
                <div className="p3">
                    <span className="p4">Not your computer?Use Guest mode to sign in privately.</span>
                    <Button variant="text"> Learn more</Button>
                </div>
                <div className="p6">
                    <div className="p7">
                        <Button className="u1" color="primary" size="small" variant="text">Create account</Button>
                    </div>
                    <div className="p8">
